...
ALL : $(ILUHOME) $(ILUHOME)\bin $(ILUHOME)\lib LISPSTUBMAKE
...
LISPSTUBMAKE :
!MESSAGE WARNING: By default, the LISP Stubber is NOT built!
!MESSAGE To build it, uncomment the following nmake line in this makefile.
#	nmake -f lispstubber.mak CFG="$(CFG)"
