...
CPP_PROJ=/nologo /MD /W3 /GX /YX /Ox /Oy- /I $(ILUHOME)\include \
 ...
 /Fp$(OUTDIR)/"server.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
DEF_FILE=
LINK32_OBJS= \
	".\WinRel\timeit-true.obj" \
	.\WinRel\server.obj \
	".\WinRel\timeit-common.obj"
...
CPP_PROJ=/nologo /MD /W3 /GX /Zi /YX /Od /I $(ILUHOME)\include \
 ...
 /Fp$(OUTDIR)/"server.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"server.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 \ilu\lib\iluc32.lib \ilu\lib\ilu32.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /NOLOGO /SUBSYSTEM:console /DEBUG /MACHINE:I386
LINK32_FLAGS=$(ILUHOME)\lib\iluc32.lib $(ILUHOME)\lib\ilu32.lib wsock32.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /NOLOGO\
...
DEF_FILE=
LINK32_OBJS= \
	".\WinDebug\timeit-true.obj" \
	.\WinDebug\server.obj \
	".\WinDebug\timeit-common.obj"
...
".\WinRel\timeit-true.obj" :  $(SOURCE)  $(DEP_TIMEI) $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 Debug"

".\WinDebug\timeit-true.obj" :  $(SOURCE)  $(DEP_TIMEI) $(INTDIR)
...
".\WinRel\timeit-common.obj" :  $(SOURCE)  $(DEP_TIMEIT) $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 Debug"

".\WinDebug\timeit-common.obj" :  $(SOURCE)  $(DEP_TIMEIT) $(INTDIR)
