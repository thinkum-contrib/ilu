...
CPP_PROJ=/nologo /MD /W3 /GX /YX /Ox /Oy- /I $(ILUHOME)\include \
 ...
 /Fp$(OUTDIR)/"client.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/timeit-surrogate.obj \
	$(INTDIR)/timeit-common.obj \
	$(INTDIR)/client.obj
...
$(INTDIR)/timeit-surrogate.obj :  $(SOURCE)  $(DEP_TIMEI) $(INTDIR)
...
$(INTDIR)/timeit-common.obj :  $(SOURCE)  $(DEP_TIMEIT) $(INTDIR)
