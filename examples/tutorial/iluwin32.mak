# Top level makefile to build Win32 version of ILU Tutorial
...
!MESSAGE NOTE: that only the Java version of the Tutorial 
!MESSAGE is set up to be build with this makefile
