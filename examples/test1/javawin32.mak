# Top level makefile to build Win32 java version of ILU test1
...
JAVAMAKE :
	java-stubber Test1.isl
	java-stubber Test2.isl
	java-stubber Test3.isl
	if not exist $(JAVA_CLASS_DIR)\nul mkdir $(JAVA_CLASS_DIR)
	set CLASSPATH=.;$(JAVA_CLASS_DIR);$(ILUHOME)\lib\classes;$(CLASSPATH)
	$(JAVAC) $(ILU_JAVAC_FLAGS) $(JAVA_STUBS_DIR)\Test1\*.java
	$(JAVAC) $(ILU_JAVAC_FLAGS) $(JAVA_STUBS_DIR)\Test2\*.java
	$(JAVAC) $(ILU_JAVAC_FLAGS) $(JAVA_STUBS_DIR)\Test3\*.java
	$(JAVAC) $(ILU_JAVAC_FLAGS) TestClient.java TestServer.java
