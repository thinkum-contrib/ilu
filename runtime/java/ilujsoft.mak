...
ALL : "$(ILUHOME)\bin\ilujava$(ILUJG).dll"
...
CLEAN :
    ...
    -@erase "$(OUTDIR)\ilujava.exp"
    -@erase "$(OUTDIR)\ilujava$(ILUJG).lib"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "$(JAVA_HOME)\misc" /I\
 "$(JAVA_HOME)\include\win32" /I "$(ILUSRC)\runtime\java" /I\
 "$(ILUSRC)\runtime\java\build" /I "$(ILUSRC)\runtime\kernel" /I "$(ILUSRC)\GSS\kernel" /I\
 "$(JAVA_HOME)\include" /D "NDEBUG" /D "ONI" /D "WIN32" /D "_WINDOWS" /D\
 "ILU_BUILDING_RUNTIME" \
 /Fp"$(INTDIR)\ilujava.pch" /YX /Fo"$(INTDIR)\\"\
 /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\WinRel/
CPP_SBRS=.
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\ilujava.bsc" 

    
LINK32=link.exe
LINK32_FLAGS=$(ILUHOME)\lib\ilu32.lib $(ILUHOME)\lib\gss.lib $(JAVA_HOME)\lib\javai$(ILUJG).lib wsock32.lib\
 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo\
 /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\javai$(ILUJG).pdb"\
 /machine:I386 /out:"$(ILUHOME)\bin\ilujava$(ILUJG).dll" /implib:"$(OUTDIR)\ilujava$(ILUJG).lib" 
LINK32_OBJS= \
...
"$(ILUHOME)\bin\ilujava$(ILUJG).dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
    ...
    -@erase "$(OUTDIR)\ilujava.bsc"
    -@erase "$(OUTDIR)\ilujava.exp"
    -@erase "$(OUTDIR)\ilujava$(ILUJG).lib"
    -@erase "$(OUTDIR)\javai$(ILUJG).pdb"
    -@erase "$(ILUHOME)\bin\ilujava.ilk"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Gm /GX /Zi /Od /I "$(JAVA_HOME)\include\win32" /I\
 "$(JAVA_HOME)\include" /I "$(ILUSRC)\runtime\java" /I\
 "$(ILUSRC)\runtime\java\build" /I "$(ILUSRC)\runtime\kernel" /I "$(ILUSRC)\GSS\kernel" /D\
 "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "ONI" /D "ILU_BUILDING_RUNTIME" \
  $(ILU_DEBUG_JFLAGS) /Fp"$(INTDIR)\ilujava.pch" /YX\
...
DEP_CPP_ILUJA=\
    ...
    "$(JAVA_HOME)\include\bool.h"\
    "$(JAVA_HOME)\include\config.h"\
    "$(JAVA_HOME)\include\debug.h"\
    "$(JAVA_HOME)\include\interpreter.h"\
    "$(JAVA_HOME)\include\java_lang_string.h"\
    "$(JAVA_HOME)\include\javastring.h"\
    "$(JAVA_HOME)\include\jcov.h"\
    "$(JAVA_HOME)\include\jni.h"\
    "$(JAVA_HOME)\include\native.h"\
    "$(JAVA_HOME)\include\oobj.h"\
    "$(JAVA_HOME)\include\signature.h"\
    "$(JAVA_HOME)\include\stubpreamble.h"\
    "$(JAVA_HOME)\include\sys_api.h"\
    "$(JAVA_HOME)\include\timeval.h"\
    "$(JAVA_HOME)\include\tree.h"\
    "$(JAVA_HOME)\include\typecodes.h"\
    "$(JAVA_HOME)\include\typedefs.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\dirent.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\io_md.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\jni_md.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\mutex_md.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\oobj_md.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\sysmacros_md.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\timeval_md.h"\
    "$(JAVA_HOME)\$(JAVAMDINCLUDES)\typedefs_md.h"\
    {$(INCLUDE)}"sys\types.h"\
...
DEP_CPP_ILUJAVA=\
    ...
    "$(JAVA_HOME)\include\interpreter.h"\
    "$(JAVA_HOME)\include\java_lang_string.h"\
    "$(JAVA_HOME)\include\java_lang_thread.h"\
    "$(JAVA_HOME)\include\javastring.h"\
    "$(JAVA_HOME)\include\jcov.h"\
    "$(JAVA_HOME)\include\jni.h"\
    "$(JAVA_HOME)\include\monitor.h"\
    "$(JAVA_HOME)\include\native.h"\
    "$(JAVA_HOME)\include\oobj.h"\
    "$(JAVA_HOME)\include\signature.h"\
    "$(JAVA_HOME)\include\stubpreamble.h"\
...
DEP_CPP_ILUJAVA_L=\
    ...
    "$(JAVA_HOME)\include\java_lang_string.h"\
    "$(JAVA_HOME)\include\java_lang_thread.h"\
    "$(JAVA_HOME)\include\java_lang_threadgroup.h"\
    "$(JAVA_HOME)\include\javastring.h"\
    "$(JAVA_HOME)\include\jni.h"\
    "$(JAVA_HOME)\include\monitor.h"\
    "$(JAVA_HOME)\include\native.h"\
